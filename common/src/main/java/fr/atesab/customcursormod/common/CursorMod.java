...
public class CursorMod {
	...
	public static final String MOD_NAME = PlatformHelper.getInstance().getModName(MOD_ID);
	public static final String MOD_VERSION = PlatformHelper.getInstance().getModVersion(MOD_ID);
	public static final String MOD_AUTHORS = PlatformHelper.getInstance().getModAuthors(MOD_ID);
	public static final String MOD_LICENCE = PlatformHelper.getInstance().getModLicense(MOD_ID);
