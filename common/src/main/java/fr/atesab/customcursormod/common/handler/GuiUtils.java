...
public abstract class GuiUtils {
    ...
    public abstract void drawPreviewArea(CommonMatrixStack stack, CommonScreen screen, int x, int y, int width, int height);

    public abstract void drawCursorHotspot(CommonMatrixStack stack, CommonScreen screen, int x, int y);

    public abstract void drawConfigTitle(CommonMatrixStack stack, CommonScreen screen, int width, int height);

    public abstract void drawAnimationText(CommonMatrixStack stack, CommonScreen screen, int x, int y);
